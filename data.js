...
function updateFilterButtons() {
    ...
    document.getElementById('field_trip_filter_btn').classList.toggle('active', currentTaskTypeFilter === 'field_trip');
...
async function initialize() {
    ...
    document.getElementById("gantt_here").addEventListener("contextmenu", function(e) {
        ...
        // コピーは常に有効（貼り付け時に工事番号1件チェックを行う）
        document.getElementById("gantt_ctx_copy").classList.remove('disabled');
        document.getElementById("gantt_ctx_copy_multi").classList.remove('disabled');
        // 貼り付けの有効/無効
